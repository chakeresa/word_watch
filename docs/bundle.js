...
const displayTopWordResult = (topWordApiResult) => {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#top-word').html('Top word from Word Watch API:');

  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#top-word').append(`
    "${Object.keys(topWordApiResult.word)}"
  `);
  
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#word-count').html('');
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#break-down-button').on('click', () => {
    event.preventDefault(); //don't do a post request automatically
    let textInput = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("textarea#text-input").val()
